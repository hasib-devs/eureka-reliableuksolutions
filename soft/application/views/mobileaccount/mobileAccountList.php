              ...
              <table class="table-responsive table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr class="gradeX">
                    ...
                    <td>
                      <?php if($_SESSION['editMAccount'] == 1){ ?>
                      ...
                      <?php } if($_SESSION['deleteMAccount'] == 1){ ?>
          ...
          <div class="modal-content">
            ...
            <form action="<?php echo base_url('MobileAccount/update_mobile_account');?>" method="post">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <input type="hidden" id="mobileAccountId" name="mobileAccountId" required >
                <div class="modal-footer">
