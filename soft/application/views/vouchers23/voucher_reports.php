  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Voucher Received Report</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>Dashboard">Dashboard</a></li>
              <li class="breadcrumb-item active">Voucher Received Report</li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Voucher Received Report</h3>
            </div>

            <div class="card-body">
              <div class="col-sm-12 col-md-12 col-12">
                <form action="<?php echo base_url() ?>vrReport" method="get">
              ...
              <div id="print">
                <div class="col-sm-12 col-md-12 col-12">
                  ...
                  <div class="box-header" style="text-align: center;">
                    <h3 class="box-title"><b>Voucher Received Reports in : <?php echo $sdate.' - '.$edate; ?></b></h3>
                  </div>
                  <?php } else if ($report == 'monthlyReports') { ?>
                  <div class="box-header" style="text-align: center;">
                    <h3 class="box-title"><b>Voucher Received Reports in : <?php echo $name.' '.$year; ?></b></h3>
                  </div>
                  <?php } else if ($report == 'yearlyReports') { ?>
                  <div class="box-header" style="text-align: center;">
                    <h3 class="box-title"><b>Voucher Received Reports in : <?php echo $year; ?></b></h3>
                  </div>
                  <?php } ?>
                  <?php } ?>      
                  ...
                  <table id="example" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <?php if($customer){ ?>
                        <?php echo $customer->custName.' ( '.$customer->custCode.' )'; ?>
                        <?php } else{ ?>
                        <?php echo 'N/A'; ?>
                        <?php } ?>
                        </td>
