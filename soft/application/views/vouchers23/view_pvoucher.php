                ...
                <div id="print">
                  <div class="col-sm-12 col-md-12 col-12">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div style="text-align: center;"><h3><b><?php echo 'Payment Voucher'; ?></b></h3></div>
                    </div><br>
                    <div class="row">
                      ...
                      <div class="col-md-5 col-sm-5 col-5">
                        ...
                        <div class="col-md-12 col-sm-12 col-12">
                          Date&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo date('d-m-Y',strtotime($voucher['vuDate'])); ?>
                        </div>
                      </div>
                    </div><br>
                    <div class="row">
                    ...
                    <?php if($voucher['notes'] != null){ ?>
                    <div class="row">
                      <p class="lead">Note / Remarks&nbsp;:&nbsp;</p>
                      <p class="lead"><?php echo $voucher['notes']; ?></p>
                    </div>
                    <?php } ?>
