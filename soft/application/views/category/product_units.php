                ...
                <table class="table table-responsive table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">      
                      ...
                      <td>
                        <?php if($_SESSION['editUnit'] == 1){ ?>
                        <button type="button" class="btn btn-success btn-xs unit_edit" data-toggle="modal" data-target=".bs-example-modal-unit_edit" data-id="<?php echo $value['untid']; ?>" ><i class="fa fa-edit"></i></button>
                        <?php } if($_SESSION['deleteUnit'] == 1){ ?>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $(".unit_edit").click(function(){
          var untid = $(this).data('id');
            //alert(l_id);
          $('input[name="untid"]').val(untid);
          });
