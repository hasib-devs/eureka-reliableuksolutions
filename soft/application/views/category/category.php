                ...
                <table id="example" class="table table-responsive table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">      
                      ...
                      <td>
                        <?php if($value['catid'] > 8){ ?>
                        <?php if($_SESSION['editCategory'] == 1){ ?>
                        <button type="button" class="btn btn-success btn-xs category_edit" data-toggle="modal" data-target=".bs-example-modal-category_edit" data-id="<?php echo $value['catid']; ?>" ><i class="fa fa-edit"></i></button>
                        <?php } if($_SESSION['deleteCategory'] == 1){ ?>
