                ...
                <table class="table table-responsive table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">
                      ...
                      <td>
                        <button type="button" class="btn btn-success btn-xs cost_edit" data-toggle="modal" data-target=".bs-example-modal-cost_edit" data-id="<?php echo $value['ctid']; ?>" ><i class="fa fa-edit"></i></button>
              ...
              <div class="modal-content">
                ...
                <form action="<?php echo base_url('Cost/update_cost_type');?>" method="post">
                  <div class="form-group col-md-12 col-sm-12 col-12">
                    ...
                    <input type="text" class="form-control" name="costName" id="costName" required >
                  </div>
                  <div class="form-group col-md-12 col-sm-12 col-12">
                    <label>Status</label>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo base_url() ?>Cost/save_expense_type">
                  <div class="form-group col-md-12 col-sm-12 col-12">
                    <label>Expense Type *</label>
                    <input type="text" class="form-control" name="costName" placeholder="Expense Type" required >
                  </div>
                  <div class="form-group col-md-12 col-sm-12 col-12" >
