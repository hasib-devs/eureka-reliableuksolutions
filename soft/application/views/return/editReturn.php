                ...
                <form method="POST" action="<?php echo base_url() ?>Returns/save_returns" >
                  <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      ...
                      <select class="form-control select2" name="customer" required >
                        ...
                        <option <?php echo ($returns['custid'] == $value['custid'])?'selected':''?> value="<?php echo $value['custid'] ?>"><?php echo $value['custName'].' ( '.$value['custCode'].' )'; ?></option>
                        <?php } ?>
                      </select>
                    </div> 
                    <div class="form-group col-md-4 col-sm-4 col-12">
                    ...
                    <table id="mtable" class="table table-bordered table-striped">
                      ...
                      <tbody id="tbody">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type='text' onkeyup='totalPrice(<?php echo $id ?>)' name='sprice[]' id='sprice_<?php echo $id ?>' value="<?php echo $value['sprice']; ?>" required >
                          </td>
                          <td>
                            <input type='text' class='tprice' name='tprice[]' readonly id='tprice_<?php echo $id ?>' value="<?php echo $value['tprice']; ?>" required >
                          </td>
                          <td>
                            <span class="item_remove btn btn-danger btn-sm" onclick='deleteProduct(this)'><i class='fa fa-trash'></i></span>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      ...
                      <input type="text" class="form-control" name="sAmount" id="sAmount" value="0" onkeyup="discountType()" >
                    </div>
                    <div class="form-group col-md-4 col-sm-4 col-12">
...
<?php $this->load->view('footer/footer'); ?>
    ...
    <script type="text/javascript">
      $('#productID').on('change',function(){
        ...
        //alert(productID);
        var info = {'id':id};
        var url = '<?php echo base_url() ?>'+'Returns/getDetails/';
