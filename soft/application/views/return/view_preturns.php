                  ...
                  <div id="print">
                    ...
                    <div class="row invoice-info">
                      ...
                      <div class="col-sm-4 col-4 invoice-col">
                        To
                        <address>
                          <?php echo $returns['supName']; ?><br>
                          Phone : <?php echo $returns['supMobile']; ?><br>
                          Address : <?php echo $returns['supAddress']; ?><br>
                        </address>
                      </div>
                      <div class="col-sm-4 col-4 invoice-col">
                        <b>Invoice No. # <?php echo $returns['prCode']; ?></b><br>
                        <b>Sale Inv. No. # <?php echo $returns['challan']; ?></b><br>
                        <b>Payment Mode :</b> <?php echo $returns['accountType']; ?><br>
                        <b>Return Date :</b> <?php echo date('d-M-Y', strtotime($returns['prDate'])); ?>
                      </div>
                    </div>

                    <div class="row">
                      <div class="col-sm-12 col-md-12 col-12">
                        <h3 style="text-align: center;"><b>Purchase Return Invoice</b></h3>
                      </div>
