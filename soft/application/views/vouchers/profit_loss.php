                        ...
                        <tbody>
                          <tr>
                            ...
                            <td style="width: 20%;">
                              ...
                              ?>
                              <?php $tpa += ($value->quantity*$value->tamount); ?>
                              <?php } ?>
                              <?php echo number_format($tpa, 2); ?>
                            </td>
                          </tr>
                          <tr>
                            <td>2</td>
                          ...
                          <tr>
                            <td>3</td>
                            <td>Money Receipt</td>
                            <td><?php echo number_format($spayment->total, 2); ?></td>
                            <td>3</td>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php $ti = $sale->total+$cvoucher->total+$spayment->total; ?>
                              <?php echo number_format($ti, 2); ?>
                              </td>
                            <td colspan="2" style="text-align: center;">Total Expense</td>
                            <td>
                              <?php $te = $tpa+$dvoucher->total+$empp->total+$return->total; ?>
