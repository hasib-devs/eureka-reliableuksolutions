                    ...
                    <table id="mtable" class="table table-bordered table-striped">
                      ...
                      <tbody id="tbody">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type='text' class='form-control' name='sprice[]' id='sprice_<?php echo $pid; ?>' onkeyup='getTotal(<?php echo $value['pid']; ?>)' value='<?php echo $value['oPrice']?>' required readonly >
                          </td>
                          <td>
                            <input type='text' class='form-control tprice' name='tprice[]' id='tprice_<?php echo $pid?>' value='<?php echo $value['tPrice']; ?>' readonly >
                          </td>
                          <td>
