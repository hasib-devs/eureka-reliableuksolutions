                ...
                <form method="POST" action="<?php echo base_url() ?>Sale/update_new_sale" >
                    ...
                    <table id="mtable" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" class="form-control" name="nAmount" id="nAmount" value="<?php echo (($sale['tAmount']+$sale['vat'])-$sale['disAmount']); ?>" required readonly >
                          </td>
                        </tr>
                        <tr>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      ...
                      <div>
                        <input type="radio" name="psType" value="1" required >&nbsp;&nbsp;Yes&nbsp;&nbsp;
                        <input type="radio" name="psType" value="0" required >&nbsp;&nbsp;No
                      </div>
                    </div>
                    <div class="form-group col-md-4 col-sm-4 col-12">
                      <label>Note</label>
