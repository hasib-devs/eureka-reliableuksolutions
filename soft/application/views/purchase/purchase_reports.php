                      ...
                      <table id="example1" class="table table-responsive table-bordered" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo date('j F Y',strtotime($result->puDate)) ?></td>
                            <td><?php echo $result->supName; ?></td>
                            <td><?php echo number_format($result->tAmount, 2); $tp += $result->tAmount; ?></td>
                            <td><?php echo number_format($result->vAmount, 2); $tv += $result->vAmount; ?></td>
                            <td><?php echo number_format($result->pAmount, 2); $tpa += $result->pAmount; ?></td>
