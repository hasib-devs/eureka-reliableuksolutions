                  ...
                  <div class="col-sm-12 col-md-12 col-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-6" style="text-align:left; margin-left:-170px;">
                        <b>Payment Receipt No.&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo $empp['empPid']; ?></b>
                      </div>
                    ...
                    <table class="table table-bordered">
                        <tr style="line-height:6px;">
                          ...
                          <td class="border border-dark" style=" "><?php echo  $empp['empCode']; ?></td>
                        ...
                        <tr style="line-height:6px;">
                          ...
                          <td class="border border-dark" style=" "><?php echo $empp['dptName'];?></td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr style="line-height:6px;">
                          ...
                          $monthName = date('F', mktime(0, 0, 0, $monthNum, 10)); echo $monthName; // March
                           ?>&nbsp Salary </td>
                          <td colspan="1" class="border border-dark" style=" "><?php echo number_format($empp['salary'], 2); ?></td>
                        </tr>
                        <?php if($empp['bonus']) {?>
                        <tr style="line-height:6px;">
                        ...
                        <tr style="line-height:6px;">
                          ...
                          <td colspan="1" class="dark border border-dark" style="  "><?php echo number_format($empp['advance'], 2); ?></td>
                        </tr>
                        <?php } ?>
                        <tr style="line-height:6px;">
                          <td colspan="3" class="dark border border-dark" style="background-color: aliceblue !important;  "><b>TOTAL AMOUNT</b> </td>
                          <td colspan="1" class="dark border border-dark" style="background-color: aliceblue !important;  "><b><?php echo number_format($empp['pAmount'], 2); ?></b></td>
                        </tr>
                    </table>
                  <div class="row" >
                    <div class="col-md-2 col-sm-2 col-xs-2" style="text-align:left; margin-left:-170px;"></div>
                    <?php $twa = abs(round($empp['pAmount'])); ?>
