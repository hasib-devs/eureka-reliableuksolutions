        ...
        $(document).ready(function(){
          $('#syear').change(function(){
            ...
            $.ajax({
              ...
              for (var key in data) 
                {
                HTML +='<tr><td>'+'<input type="checkbox" name="checkbox[]" value="'+data[key]['empid']+'"></td><td>'+ data[key]['empName']+'</td><td>'+ data[key]['dptName']+'</td><td>'+ data[key]['joinDate']+'</td><td>'+ data[key]['salary']+'<input type="hidden" name="salary[]" value="'+data[key]['salary']+'"></td><tr>';
                  }
              $("#empsalary").html(HTML);
                },
              error:function(data){
