            ...
            <div class="card">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo site_url("Quotation/update_Quotation ") ?>">
                  <input type="hidden" name="qutid" value="<?php echo $quotation['qutid']; ?>" required >
                  <div class="row sticky-top">
                    <div class="form-group col-md-3 col-sm-3 col-12">
                      <label>Quotation Date *</label>
                      <input type="text" name="date" class="form-control datepicker" value="<?php echo date('m/d/Y',strtotime($quotation['qutDate'])); ?>" required >
                    </div>
                    <div class="form-group col-md-3 col-sm-3 col-12">
                    ...
                    <!--  <label>Select Product</label>                        -->
                    <!--  <select id="products" class="form-control chosen" >-->
                    <!--    <option value=" ">Select One</option>-->
                    ...
                    <table id="mtable" class="table table-bordered table-striped">
                      ...
                      <tbody id="tbody">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type='text' class="form-control" onkeyup='totalPrice(<?php echo $i; ?>)' name='quantity[]' id='quantity_<?php echo $i; ?>' value="<?php echo $value['quantity']; ?>" required >
                          </td>
                          <td>
                            <input type='text' class="form-control" name='sprice[]' id='sprice_<?php echo $i; ?>' onkeyup='totalPrice(<?php echo $i; ?>)' value="<?php echo $value['tprice']/$value['quantity']; ?>" required >
                          </td>
                          <!--<td>-->
                          <!--  <input type='text' class="form-control" name='iprice[]' value="<?php echo $value['iprice']; ?>" readonly >-->
                          <!--</td>-->
                          <td>
                            <input type='text' class='form-control tprice' name='tprice[]' id='tprice_<?php echo $i; ?>' value="<?php echo $value['tprice']?>" readonly >
                          </td>
                          <td>
