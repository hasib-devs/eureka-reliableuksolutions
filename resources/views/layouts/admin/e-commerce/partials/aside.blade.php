...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:#FFFFFF;">
    <!-- Brand Logo -->
    ...
    <a href="{{ routeHelper('video') }}" 
       class="nav-link {{ Request::is('admin/video') ? 'active' : '' }}">
        ...
        <p>Videos</p>
                ...
                <!--Start banner-->
<li class="nav-item {{Request::is('admin/banner*') ? 'menu-is-opening menu-open':''}}">
    <a href="javascript:void(0)" class="nav-link">
        <i class="nav-icon fas fa-images"></i>
        <p>
            Banners
    ...
    <ul class="nav nav-treeview">
        <li class="nav-item">
            <a href="{{routeHelper('banner/create')}}"
                class="nav-link {{Request::is('admin/banner/create') ? 'active':''}}">
                <i class="fas fa-plus-circle nav-icon"></i>
                <p>Add</p>
            </a>
        </li>
        <li class="nav-item">
            <a href="{{routeHelper('banner')}}"
               ...
               <!--End banner-->  
                ...
                <!--new slider-->
                <li class="nav-item {{Request::is('admin/sliderone*') ? 'menu-is-opening menu-open':''}}">
                    <a href="javascript:void(0)" class="nav-link">
                        <i class="nav-icon fas fa-images"></i>
                        <p>
                            Sliders One
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{routeHelper('sliderone/create')}}"
                                class="nav-link {{Request::is('admin/sliderone/create') ? 'active':''}}">
                                <i class="fas fa-plus-circle nav-icon"></i>
                                <p>Add</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{routeHelper('sliderone')}}"
                                class="nav-link {{Request::is('admin/sliderone') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{Request::is('admin/order*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            ...
                            <a href="{{route('admin.incomplete.leads.index')}}"
                                class="nav-link {{Request::is('admin/incomplete-leads') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.ip_block.index') }}" class="nav-link">
