...
@push('css')
    ...
    <style>
        ...
        /* Make slides fully responsive and prevent inline width/float overflow */
.product-flexslider .flex-viewport { overflow: hidden; position: relative; height: auto !important; }
.product-flexslider .slides { display: block !important; width: 100% !important; padding: 0; margin: 0; }
...
/* image styles */
.product-flexslider .thumb-image img,
.product-flexslider .thumb-image a img,
.product-flexslider .my-gallery-image {
  width: 100%;
  height: auto;
  max-width: 100%;
  display: block;
...
/* video responsive */
.product-flexslider .video-wrap { width: 100%; }
.product-flexslider .video-embed { position: relative; width: 100%; padding-bottom: 56.25%; /* 16:9 */ height: 0; }
.product-flexslider .video-embed iframe { position: absolute; top:0; left:0; width:100%; height:100%; border:0; }
.product-flexslider .responsive-video { width:100%; height:auto; max-height: 60vh; }

/* small screens tweaks */
@media (max-width: 576px) {
  .product-flexslider .thumb-image img { height: auto; }
  .product-flexslider { padding: 8px; }
}
            ...
            <div class="row"
                ...
                <div class="col-md-4 single-right-left">
                  <div class="grid images_3_of_2">
                    <div class="flexslider product-flexslider" style="padding: 12px; box-shadow: none; border: 1px solid #e0e0e0;">
                      <div class="flex-viewport">
                        <ul class="slides my-gallery">
                          @if ($product->yvideo)
                            <li data-thumb="{{ asset('uploads/product/video/' . $product->video_thumb) }}">
                              <div class="thumb-image video-wrap">
                          ...
                          @foreach ($product->images as $image)
                            <li data-cl="{{ $image->color_attri }}" data-thumb="{{ asset('uploads/product/' . $image->name) }}">
                ...
                <div class="col-md-5 single-right-left simpleCart_shelfItem">
                    ...
                    @if ($product->sku)
                        <p>Vehicle Compatibility: <b><i>{{ $product->sku }}</i></b></p>
                    @endif
                    @isset($product->user->shop_info->name)
                        <!--<p>
                                                                                                                                                                    Seller: <a style="font-size: 17px"
