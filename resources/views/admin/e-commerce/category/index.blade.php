                ...
                <tbody>
                    @foreach ($categories as $key => $data)
                        <tr>
                            ...
                            <td>
                                <span class="badge badge-{{ $data->is_shown_on_homepage ? 'success' : 'danger' }}">{{ $data->is_shown_on_homepage ? 'Yes' : 'No' }}</span>
                            </td>
                            <td>
                                <a href="{{route('category.product',['slug'=>$data->slug])}}" class="btn btn-success btn-sm">
