            ...
            <div class="card">
                ...
                <form action="{{ isset($category) ? routeHelper('category/'.$category->id) : routeHelper('category') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" name="is_shown_on_homepage" id="is_shown_on_homepage" @isset ($category) {{ $category->is_shown_on_homepage ? 'checked':'' }} @else checked @endisset>
